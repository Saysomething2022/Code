...
public class UploadPictureServiceimpl implements UploadPictureService {
    ...
    public String uploadPicture(MultipartFile file) throws IOException {
        String qiniuUrl = "rjxfn5zxa.hn-bkt.clouddn.com";
        Configuration configuration = new Configuration(Region.autoRegion());
        UploadManager uploadManager = new UploadManager(configuration);
        String accessKey = "B7t8_JEzuTzhOdcsQrKr1lXYxdSecToJ0xa-QgXx";
        String secretKey = "dUTIo_Setnhl_t2Wd289Nn5F81bzuu9wlMLPfvcc";
        String bucket = "picture119";
