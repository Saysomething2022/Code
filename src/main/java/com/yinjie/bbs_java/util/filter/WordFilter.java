package com.yinjie.bbs_java.util.filter;
...
public class WordFilter {
    ...
    private static List<String> readWordsFile() {
        ...
        try {
            Resource resource = new DefaultResourceLoader().getResource("classpath:sensitive-words.txt");
...
//        System.out.println("算法模型==》"+sensitiveWordMap);
